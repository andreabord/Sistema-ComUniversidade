...
<body>
            ...
            <div id="inputs-content">
                ...
                <div class="input-container">
                    @error('tipo_pessoa')
                        ...
                        <select title="{{ $message }}" class="alert-danger custom-select" autocompĺete="off" type="text" id="tipo_pessoa" name="tipo_pessoa" value="{{old('tipo_pessoa')}}" required>
                    ...
                    @else
                        <label for="tipo_pessoa">Tipo Pessoa *</label>
                        <select class="custom-select" name="tipo_pessoa" id="tipo_pessoa" autocompĺete="off" value="{{old('tipo_pessoa')}}" required>
                            <option value="" selected disabled>Escolha uma opção</option>
                            <option value="FISICA" {{ "FISICA" === old('tipo_pessoa') ? 'selected' : '' }}>Física</option>
                            <option value="JURIDICA" {{ "JURIDICA" === old('tipo_pessoa') ? 'selected' : '' }}>Jurídica</option>
                        </select>
                ...
                <div class="input-container">
                    @error('instituicao')
                        ...
                        <input title="{{ $message }}" class="alert-danger input-text" autocompĺete="off" type="text" id="instituicao" name="instituicao" value="{{old('instituicao')}}" maxlength="100">
                    @else                        
                        <label for="instituicao">Instituição</label>
                        <input class="input-text" type="text" id="instituicao" name="instituicao" autocompĺete="off" value="{{old('instituicao')}}" maxlength="100">
                    @enderror
                </div>
            </div>
    ...
    <div class="login-content">
        ...
        <a href="{{ route('login_membro_index') }}" class="button-a-secondary">Entre</a>
    </div>
