...
<body>
    ...
    <div class="modal modal-large" id="modal-contatar-{{$idOferta}}">
        ...
        <form id="form-contato-{{$idOferta}}" action="{{ route('contato_direto_store', $idOferta) }}" method="POST" onsubmit="return validarEnviarFormulario({{$idOferta}})">
            ...
            <div class="offer-buttons">
                ...
                <button type="button" class="button-b-secondary" onclick="closeModalContatarOferta({{$idOferta}})" id="botao-fechar-modal-contatar">Voltar</button>
            </div>
        </form>
    </div>
    <!-- MODAL -->
    ...
    <!-- MODAL SUCESSO -->
        <div class="modal modal-small" id="modal-sucesso-{{$idOferta}}" style="diplay:none;">
