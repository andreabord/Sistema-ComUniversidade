...
<body>
            ...
            <div class="inputs-content">
                ...
                <div class="input-container">
                    @error('link_curriculo')
                        <label for="link_curriculo">Link Curriculo</label>
                        <input title="{{ $message }}" class="alert-danger input-text" autocompĺete="off" type="text" id="link_curriculo" name="link_curriculo" value="{{ old('link_curriculo') }}" maxlength="100">
                    @else
                        <label for="link_curriculo">Link Curriculo</label>
                        <input class="input-text" type="text" id="link_curriculo" name="link_curriculo" autocompĺete="off" value="{{ old('link_curriculo') }}" maxlength="100">
                    @enderror
                </div>
                ...
                <div class="input-container">
                    @error('numero_registro')
                        <label for="numero_registro">Número Registro (somente números) *</label>
                        <input title="{{ $message }}" class="alert-danger input-text" autocompĺete="off" type="number" id="numero_registro" name="numero_registro" value="{{old('numero_registro')}}" required maxlength="30">
                    @else
                        <label for="numero_registro">Número Registro (somente números) *</label>
                        <input class="input-text" type="number" id="numero_registro" name="numero_registro" autocompĺete="off" value="{{old('numero_registro')}}" required maxlength="30">
                    @enderror
                </div>
            </div>
    ...
    <div class="login-content">
        ...
        <a href="{{ route('login_professor_index') }}" class="button-a-secondary">Entre</a>
    </div>
</body>
