...
function openModalConfirmaContatoRespondido(id) {
    ...
    document.getElementById(`modal-confirmar-contato-respondido-${id}`).style.visibility = 'visible';
    document.getElementById(`clicar-fora-modal-confirmar-contato-respondido-${id}`).style.visibility = 'visible';
    document.getElementById(`modal-visualizar-${id}`).style.visibility = 'hidden';
    document.getElementById(`clicar-fora-modal-visualizar-recebido-${id}`).style.visibility = 'hidden';
...
function closeModalConfirmaContatoRespondido(id) {
    ...
    document.getElementById(`modal-confirmar-contato-respondido-${id}`).style.visibility = 'hidden';
    document.getElementById(`clicar-fora-modal-confirmar-contato-respondido-${id}`).style.visibility = 'hidden';
    document.getElementById(`modal-visualizar-${id}`).style.visibility = 'visible';
    document.getElementById(`clicar-fora-modal-visualizar-recebido-${id}`).style.visibility = 'visible';
}
